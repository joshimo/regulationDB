    ...
    <body>
        ...
        <form action="/regulation/create" method="post" enctype="multipart/form-data">
            ...
            <div class="inner_div">
                ...
                <textarea rows="3" cols="100" name="docName" required></textarea><br/>
                <p>Краткое описание документа:</p>
                <textarea rows="3" cols="100" name="docDescription" required></textarea><br/>
                <p>Тип документа:</p>
                <input type="text" name="docType" class="input" size="100" required/><br/>
            </div>
            ...
            <div class="inner_div">
                <input type="text" name="hashTags" class="input" size="160"/><br/>
            </div>
            <h3>Примечания и уточнения:</h3>
            <div class="inner_div">
                <textarea rows="3"  cols="160" name="notes"></textarea><br/>
            </div>
            ...
            <div class="button_div">
                <input type="submit" class="bigbutton" value="Добавить документ в базу"/>
                <input type="reset" class="bigbutton" value="Очистить"/>
